...
export default function AddExpenseModal({ isOpen, onClose, onExpenseAdded }: AddExpenseModalProps) {
  ...
  const translations = {
    ...
    sw: {
      title: 'Ongeza Gharama Mpya',
      subtitle: 'Rekodi gharama mpya ya biashara',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm() || !currentBusiness?.id) return
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          } ${focusedField === 'title' ? 'ring-2 ring-teal-500' : ''}`}
                        />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          } ${focusedField === 'amount' ? 'ring-2 ring-teal-500' : ''}`}
                        />
